...
GR_REGISTER_BLOCK(gr::basic::Convert, ([T], [U]), [ uint8_t, int16_t, int32_t, float ], [ uint8_t, int16_t, int32_t, float ])
...
GR_REGISTER_BLOCK(gr::basic::ScalingConvert, ([T], [U]), [ uint8_t, int16_t, int32_t, float ], [ uint8_t, int16_t, int32_t, float ])
...
GR_REGISTER_BLOCK(gr::basic::Abs, [T], [ uint8_t, int16_t, int32_t, float, std::complex<float> ])
...
GR_REGISTER_BLOCK(gr::basic::Imag, [T], [std::complex<float>])
...
GR_REGISTER_BLOCK(gr::basic::Real, [T], [std::complex<float>])
...
GR_REGISTER_BLOCK(gr::basic::Arg, [T], [std::complex<float>])
...
GR_REGISTER_BLOCK(gr::basic::RadiansToDegree, [T], [float])
...
GR_REGISTER_BLOCK(gr::basic::DegreeToRadians, [T], [float])
...
GR_REGISTER_BLOCK(gr::basic::ToRealImag, [T], [std::complex<float>])
...
GR_REGISTER_BLOCK(gr::basic::RealImagToComplex, [T], [float])
...
GR_REGISTER_BLOCK(gr::basic::ToMagPhase, [T], [std::complex<float>])
...
GR_REGISTER_BLOCK(gr::basic::MagPhaseToComplex, [T], [float])
...
GR_REGISTER_BLOCK(gr::basic::ComplexToInterleaved, ([T], [U]), [std::complex<float>], [float])
...
GR_REGISTER_BLOCK(gr::basic::InterleavedToComplex, ([T], [U]), [float], [std::complex<float>])

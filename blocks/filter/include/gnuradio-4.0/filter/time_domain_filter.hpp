...
GR_REGISTER_BLOCK(gr::filter::fir_filter, [T], [float])
...
GR_REGISTER_BLOCK(gr::filter::iir_filter, ([T], gr::filter::IIRForm::DF_I), [float])
GR_REGISTER_BLOCK(gr::filter::iir_filter, ([T], gr::filter::IIRForm::DF_II), [float])
GR_REGISTER_BLOCK(gr::filter::iir_filter, ([T], gr::filter::IIRForm::DF_I_TRANSPOSED), [float])
GR_REGISTER_BLOCK(gr::filter::iir_filter, ([T], gr::filter::IIRForm::DF_II_TRANSPOSED), [float])
...
GR_REGISTER_BLOCK(gr::filter::BasicFilter, ([T]), [ float, gr::UncertainValue<float> ])
GR_REGISTER_BLOCK(gr::filter::BasicFilterProto, ([T], gr::Resampling<1UZ, 1UZ, false>), [ float, gr::UncertainValue<float> ])
...
GR_REGISTER_BLOCK(gr::filter::Decimator, [T], [ uint8_t, int16_t, int32_t, float, std::complex<float>, gr::UncertainValue<float> ])

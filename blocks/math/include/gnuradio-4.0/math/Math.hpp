...
GR_REGISTER_BLOCK("gr::math::AddConst", gr::math::MathOpImpl, ([T], std::plus<[T]>), [ uint8_t, int16_t, int32_t, float, std::complex<float> ])
GR_REGISTER_BLOCK("gr::math::SubtractConst", gr::math::MathOpImpl, ([T], std::minus<[T]>), [ uint8_t, int16_t, int32_t, float, std::complex<float> ])
GR_REGISTER_BLOCK("gr::math::MultiplyConst", gr::math::MathOpImpl, ([T], std::multiplies<[T]>), [ uint8_t, int16_t, int32_t, float, std::complex<float> ])
GR_REGISTER_BLOCK("gr::math::DivideConst", gr::math::MathOpImpl, ([T], std::divides<[T]>), [ uint8_t, int16_t, int32_t, float, std::complex<float> ])
...
GR_REGISTER_BLOCK("gr::math::Add", gr::math::MathOpMultiPortImpl, ([T], std::plus<[T]>), [ uint8_t, int16_t, int32_t, float, std::complex<float> ])
GR_REGISTER_BLOCK("gr::math::Subtract", gr::math::MathOpMultiPortImpl, ([T], std::minus<[T]>), [ uint8_t, int16_t, int32_t, float, std::complex<float> ])
GR_REGISTER_BLOCK("gr::math::Multiply", gr::math::MathOpMultiPortImpl, ([T], std::multiplies<[T]>), [ uint8_t, int16_t, int32_t, float, std::complex<float> ])
GR_REGISTER_BLOCK("gr::math::Divide", gr::math::MathOpMultiPortImpl, ([T], std::divides<[T]>), [ uint8_t, int16_t, int32_t, float, std::complex<float> ])

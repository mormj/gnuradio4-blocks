...
GR_REGISTER_BLOCK("gr::testing::ImChartMonitor", gr::testing::ImChartMonitor, ([T], true), [float]);
GR_REGISTER_BLOCK("gr::testing::ConsoleDebugSink", gr::testing::ImChartMonitor, ([T], false), [float]);

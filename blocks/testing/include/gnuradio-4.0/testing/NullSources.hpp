...
GR_REGISTER_BLOCK(gr::testing::NullSource, [T], [ uint8_t, int16_t, int32_t, float, std::complex<float>, gr::Packet<float>, gr::Tensor<float>, gr::DataSet<float> ])
...
GR_REGISTER_BLOCK(gr::testing::ConstantSource, [T], [ uint8_t, int16_t, int32_t, float, std::complex<float>, gr::Packet<float>, gr::Tensor<float>, gr::DataSet<float> ])
...
GR_REGISTER_BLOCK(gr::testing::SlowSource, [T], [ uint8_t, int16_t, int32_t, float, std::complex<float>, gr::Packet<float>, gr::Tensor<float>, gr::DataSet<float> ])
...
GR_REGISTER_BLOCK(gr::testing::CountingSource, [T], [ uint8_t, int16_t, int32_t, float, std::complex<float> ])
...
GR_REGISTER_BLOCK(gr::testing::Copy, [T], [ uint8_t, int16_t, int32_t, float, std::complex<float>, gr::Packet<float>, gr::Tensor<float>, gr::DataSet<float> ])
...
GR_REGISTER_BLOCK(gr::testing::HeadBlock, [T], [ uint8_t, int16_t, int32_t, float, std::complex<float>, gr::Packet<float>, gr::Tensor<float>, gr::DataSet<float> ])
...
GR_REGISTER_BLOCK(gr::testing::NullSink, [T], [ uint8_t, int16_t, int32_t, float, std::complex<float>, gr::Packet<float>, gr::Tensor<float>, gr::DataSet<float> ])
...
GR_REGISTER_BLOCK(gr::testing::CountingSink, [T], [ uint8_t, int16_t, int32_t, float, std::complex<float>, gr::Packet<float>, gr::Tensor<float>, gr::DataSet<float> ])
...
GR_REGISTER_BLOCK(gr::testing::SimCompute, [T], [ uint8_t, int16_t, int32_t, float, std::complex<float>, gr::Packet<float>, gr::Tensor<float>, gr::DataSet<float> ])

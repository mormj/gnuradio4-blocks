...
GR_REGISTER_BLOCK("gr::testing::TagSource", gr::testing::TagSource, ([T], gr::testing::ProcessFunction::USE_PROCESS_ONE), [float])
...
GR_REGISTER_BLOCK("gr::testing::TagMonitor", gr::testing::TagMonitor, ([T], gr::testing::ProcessFunction::USE_PROCESS_ONE), [float])
...
GR_REGISTER_BLOCK("gr::testing::TagSink", gr::testing::TagSink, ([T], gr::testing::ProcessFunction::USE_PROCESS_ONE), [float])

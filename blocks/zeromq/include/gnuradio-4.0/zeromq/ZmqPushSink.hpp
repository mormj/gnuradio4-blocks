...
public:
    ...
    GR_MAKE_REFLECTABLE(ZmqPushSink, in, endpoint, timeout, bind, pass_tags, pmt_wire_format, linger, hwm);
...
GR_REGISTER_BLOCK("gr::blocks::zeromq::ZmqPushSink", gr::blocks::zeromq::ZmqPushSink, ([T]), [ uint8_t, int16_t, int32_t, float, std::complex<float>, std::vector<float>, std::vector<std::complex<float>>, gr::pmt::Value ])
